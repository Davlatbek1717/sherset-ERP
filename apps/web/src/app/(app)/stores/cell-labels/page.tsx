  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="no-print sticky top-0 z-10 border-slate-200 border-b bg-white px-6 py-3 shadow-sm">
        {/* 2026-07-20f: flex-wrap + min-w-0/truncate — uzun subtitle (son ·
            o'lcham · tavsif) sahifani gorizontal siljitmasin. */}
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-2">
          <div className="min-w-0">
            <div className="truncate font-medium text-slate-800">Yacheyka labellari</div>
