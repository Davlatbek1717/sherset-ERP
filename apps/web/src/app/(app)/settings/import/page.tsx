...
// moysklad settings-nav parity: Настройки → Импорт (stub — the section
...
export default function SettingsImportPage() {
  ...
  return (
    <div className="px-8 py-6" data-testid="settings-stub-import">
      <h1 className="font-semibold text-2xl text-[var(--ms-text-primary)]">{t('import_title')}</h1>
