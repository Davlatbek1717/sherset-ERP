...
const SETTINGS_CARDS: SettingsCard[] = [
  ...
  {
    // Warehouses live at Склад → Склады (moysklad parity, live-verified
    // 2026-07-03) — the overview card jumps straight there.
    href: '/stores',
  ...
  {
    href: '/settings/demand-statuses',
    titleKey: 'demand_statuses_card_title',
    descriptionKey: 'demand_statuses_card_description',
    icon: Icons.tasks,
  },
  {
  ...
  {
    href: '/settings/supply-statuses',
    titleKey: 'supply_statuses_card_title',
    descriptionKey: 'supply_statuses_card_description',
    icon: Icons.tasks,
  },
  {
    href: '/settings/purchase-return-statuses',
    titleKey: 'purchase_return_statuses_card_title',
    descriptionKey: 'purchase_return_statuses_card_description',
    icon: Icons.tasks,
  },
  {
    href: '/settings/sales-return-statuses',
    titleKey: 'sales_return_statuses_card_title',
    descriptionKey: 'sales_return_statuses_card_description',
    icon: Icons.tasks,
  },
  {
    href: '/settings/commission-report-statuses',
    titleKey: 'commission_report_statuses_card_title',
    descriptionKey: 'commission_report_statuses_card_description',
    icon: Icons.tasks,
  },
  {
