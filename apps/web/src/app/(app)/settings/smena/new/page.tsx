  ...
  return (
    <div className="p-6 max-w-xl">
      ...
      <form onSubmit={submit} className="flex flex-col gap-4">
        <div>
          <label htmlFor="sm-name" className="block text-sm font-medium mb-1">
          ...
          <Input
            ...
            placeholder="1-smena, Asosiy zal"
            autoFocus
          />
        </div>

        <div>
          <label htmlFor="sm-schedule" className="block text-sm font-medium mb-1">
        ...
        <div>
          <label htmlFor="sm-org" className="block text-sm font-medium mb-1">
        ...
        <div>
          <label htmlFor="sm-emp" className="block text-sm font-medium mb-1">
