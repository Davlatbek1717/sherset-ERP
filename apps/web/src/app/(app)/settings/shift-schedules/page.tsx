    ...
    <div className="p-6 max-w-2xl">
      ...
      {data.length === 0 ? (
        ...
        <div className="flex flex-col gap-2">
          {data.map((s) => (
            <div
              key={s.id}
              className="flex items-center justify-between rounded-lg border border-[var(--ms-border-default)] bg-[var(--ms-bg-surface)] px-4 py-3"
            >
              <div>
      ...
      >
        <div className="flex flex-col gap-4 p-4">
          <div>
            <label htmlFor="ss-name" className="block text-sm font-medium mb-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="ss-start" className="block text-sm font-medium mb-1">
                Boshlanish
              </label>
              <Input
                id="ss-start"
            ...
            <div>
              <label htmlFor="ss-end" className="block text-sm font-medium mb-1">
                Tugash
              </label>
              <Input
                id="ss-end"
