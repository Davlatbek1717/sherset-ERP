...
/**
 * Jo'natma savdo cheki — TOR «TOVAR CHEKI» formatida (2026-07-17 talab).
 * Eski A4 `PrintDoc` almashtirildi — buyurtma/qaytarish bilan bir xil format.
 * Asos qatorida bog'liq buyurtma raqami ko'rinadi.
 */
