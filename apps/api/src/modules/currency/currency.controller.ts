...
export class CurrencyController {
  constructor(@Inject(CurrencyService) private readonly svc: CurrencyService) {}

  @Get()
  @RequirePermission({ entity: 'currency', action: 'view' })
  ...
  @Post()
  @RequirePermission({ entity: 'currency', action: 'create' })
  async create(@CurrentUser() user: AuthenticatedUser, @Body() body: unknown) {
    return this.svc.create(user.accountId, body);
  }

  @Patch(':id')
  @RequirePermission({ entity: 'currency', action: 'update' })
  async update(
  ...
  @Delete(':id')
  @RequirePermission({ entity: 'currency', action: 'delete' })
