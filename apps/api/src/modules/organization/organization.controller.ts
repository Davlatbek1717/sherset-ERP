...
export class OrganizationController {
  ...
  @Get()
  @RequirePermission({ entity: 'organization', action: 'view' })
  ...
  @Post()
  @RequirePermission({ entity: 'organization', action: 'create' })
  async create(@CurrentUser() user: AuthenticatedUser, @Body() body: unknown) {
    return this.svc.create(user.accountId, body);
  }

  @Patch(':id')
  @RequirePermission({ entity: 'organization', action: 'update' })
  async update(
  ...
  @Delete(':id')
  @RequirePermission({ entity: 'organization', action: 'delete' })
