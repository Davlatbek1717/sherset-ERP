...
export const CreatePurchaseOrderSchema = z.object({
  ...
  positions: z.array(PurchaseOrderPositionInputSchema), // moysklad allows an empty DRAFT; post() still requires >=1 position
...
export const UpdatePurchaseOrderSchema = CreatePurchaseOrderSchema.partial().extend({
  positions: z.array(PurchaseOrderPositionInputSchema).optional(),
