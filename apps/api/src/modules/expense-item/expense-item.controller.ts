...
export class ExpenseItemController {
  constructor(@Inject(ExpenseItemService) private readonly svc: ExpenseItemService) {}
  ...
  @Post()
  @RequirePermission({ entity: 'expenseitem', action: 'create' })
  ...
  @Delete(':id')
  @RequirePermission({ entity: 'expenseitem', action: 'delete' })
