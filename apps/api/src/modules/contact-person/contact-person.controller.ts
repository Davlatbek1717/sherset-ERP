...
export class ContactPersonController {
  constructor(@Inject(ContactPersonService) private readonly svc: ContactPersonService) {}

  @Get()
  @RequirePermission({ entity: 'contactperson', action: 'view' })
  ...
  @Post()
  @RequirePermission({ entity: 'contactperson', action: 'create' })
  async create(@CurrentUser() user: AuthenticatedUser, @Body() body: unknown) {
    return this.svc.create(user.accountId, user.sub, body);
  }

  @Patch(':id')
  @RequirePermission({ entity: 'contactperson', action: 'update' })
  async update(
  ...
  @Delete(':id')
  @RequirePermission({ entity: 'contactperson', action: 'delete' })
