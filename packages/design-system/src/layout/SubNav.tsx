...
export const SubNav = React.forwardRef<HTMLElement, SubNavProps>(
  ({ className, items, ...props }, ref) => (
    ...
    >
      <div
        className={cn(
          // Mobile (≤767px): a single swipeable row — `flex-wrap` would stack a
          // long module's ~13 tabs into a screen-tall block. Desktop keeps the
          // moysklad-parity wrap (wrapping ⇒ no overflow, scrollbar never shows).
          'flex flex-nowrap md:flex-wrap items-stretch overflow-x-auto px-4',
